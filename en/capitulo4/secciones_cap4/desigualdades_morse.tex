...
\begin{proof}
    ...
    \end{equation*}
    If, on the contrary, we apply the lemma with $S=\chi$ one arrives at
    \begin{gather*}
...
On the other hand, by what was seen at the end of Subsection \ref{subsec:aplicaciones}, $\mathbb{CP}^n$ admits a Morse function with $n+1$ critical points whose indices are the even numbers from $0$ to $2n$. That is,
\begin{equation*}
    C_{\lambda}=
    \begin{cases}
