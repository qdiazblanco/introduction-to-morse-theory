...
\begin{proof}
    ...
    \end{align*}
    Es claro que la última expresión es mayor que cero. Considaremos ahora la secuencia exacta de la terna $X\supset Y\supset Z$ (introducida en \ref{betti_subad}(i)),
    \begin{align*}
    ...
    \end{equation*}
    Agrupando los terminos adecuadamente llegamos a
    \begin{equation*}
...
\label{weak_morse_desig}
    Sean $f$ una función de Morse sobre una variedad compacta M $n$-dimensional y $C_{\lambda}$ el número de puntos críticos de índice $\lambda$ de $f$. Entonces,
    \begin{equation}
