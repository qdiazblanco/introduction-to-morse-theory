...
Sean el $n$-disco $D^n$ y su frontera $\mathbb{S}^{n-1}$, computemos los grupos de homología relativa $H_k(D^n,\mathbb{S}^{n-1})$. Por la proposición anterior, tenemos la siguiente secuencia exacta.
\[
\begin{tikzcd}[
  column sep=large,
  row sep=large,
