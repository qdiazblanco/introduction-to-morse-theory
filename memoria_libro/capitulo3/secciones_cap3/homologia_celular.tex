...
\fi
 ...
 Esto resulta en el diagrama conmutativo siguiente.
 \[
...
Seamos más claros: sean $i_{\alpha}(D^k_{\alpha})$ una $k$-celda de un CW-complejo $X$ y $\varphi_{\alpha}: \partial D_{\alpha}^k \simeq \mathbb{S}^{k-1} \to X_{k-1}$ su mapa de pegado. Entonces, $[D^k_{\alpha}:D^{k-1}_{\beta}]$ mide cuántas veces (pueden ser cero) $\varphi_{\alpha}(\partial D_{\alpha}^k)$ recorre completamente la $(k-1)$-celda $i_{\beta}(D^{k-1}_{\beta})$ y en qué sentido, si este coincide con la orientación de $i_{\beta}(D^{k-1}_{\beta})$ el signo será positivo y si difiere negativo. Así, obtenemos una suma formal de elementos de $(k-1)$-celdas, es decir, un elemento de $C^{CW}_{k-1}(X)$. 
...
\]
Este homomorfismo lleva la \textit{clase fundamental} $[\partial D_{\alpha}^k]$, que es esencialmente el generador de $H_{k-1}(\partial D_{\alpha}^k)\simeq \mathbb{Z}\langle [\partial D_{\alpha}^k]\rangle$, a un elemento de $H_{k-1}(X_{k-1})$. A continuación, el cociente $q: X_{k-1}\to X_{k-1}/X_{k-2} \simeq \vee_{\beta}\mathbb{S}_{\beta}^{k-1}$ induce otro homomorfismo en homología 
\[
q_*: H_{k-1}(X_{k-1}) \to H_{k-1}(X_{k-1}/X_{k-2}) = H_{k-1}(\vee_{\beta}\mathbb{S}_{\beta}^{k-1}) \simeq \oplus_{\beta}\mathbb{Z}\langle D^{k-1}_{\beta} \rangle = C^{CW}_{k-1}(X).
\]

A su vez, también se verifica que $\partial_{k}\circ\partial_{k+1} = 0$. Ahora que hemos visto como actuan los operadores de borde, los grupos de homología se construyen exactamente igual que en el caso simplicial. Dado un CW-complejo $X$ el \textit{k-ésimo grupo de homología celular} de $X$ es el grupo abeliano $H^{CW}_k(X)$ definido por
\begin{align*}
...
Una vez más referimos al lector a la fuente original \cite{munoz2021} si desea aclarar algunos de los detalles técnicos más finos que no vamos a demostrar aquí. Se puede demostrar que $H_k(X)\simeq H^{CW}_k(X)$ para cualquier espacio triangulado $X$. Así, por transitividad, se tiene que los grupos de homología de un espacio son isomorfos independientemente de la técnica que apliquemos para computarlos. Por ello, de ahora en adelante nos referiremos a los grupos de homología únicamente como $H_k(X)$.

También se verifica que los grupos de homología son invariantes por homeomorfismos y, de hecho, por equivalencias homotópicas (\cite[p.~111]{hatcher2002}). Enunciamos solamente el segundo resultado en virtud de que el tipo de homotopía es también invariante por homeomorfismos.
...
\begin{example}\label{ejemplos_hom_celular}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        Así, es sencillo ver que $H_0(\mathbb{S}^n)\simeq \mathbb{Z}$ por ser $\mathbb{S}^n$ conexo por caminos y que $H_1(\mathbb{S}^n), \dots, H_{n-1}(\mathbb{S}^n)$ son todos $\{0\}$ al ser vacíos los grupos de cadenas en esas dimensiones.

        Ahora, $H_{n}(\mathbb{S}^n)\simeq \mathbb{Z}$ necesariamente ya que $Z_n(\mathbb{S}^n)=C_n(\mathbb{S}^n)\simeq \mathbb{Z}$ por ser $\partial_n \equiv 0$ y $B_n(\mathbb{S}^n)=\{0\}$ por construcción del complejo de cadena.
        \item El toro $T^2$ puede ser considerado un CW-complejo con una $0$-celda $e^0$, dos $1$-celdas $e^1_1$ y $e^1_2$ y una $2$-celda $e^2$ de la siguiente manera. Tómese la construcción habitual del toro plano, un cuadrado cuyos lados paralelos han sido identificados. La frontera de dicho cuadrado es la suma wedge de dos circunferencias, $\mathbb{S}^1\vee \mathbb{S}^1$, es decir, dos circunferencias tangentes, estas serán nuestras $1$-celdas, el punto de tangencia nuestra $0$-celda. La $2$-celda será el interior del cuadrado.
        
        Ahora, $C_2(T^2)\simeq \mathbb{Z}\langle e^2 \rangle \simeq \mathbb{Z}$, $C_1(T^2)\simeq \mathbb{Z}\langle e^1_1 \rangle \oplus \mathbb{Z}\langle e^1_2 \rangle \simeq \mathbb{Z}^2$ y $C_0(T^2)\simeq \mathbb{Z}\langle e^0 \rangle\simeq \mathbb{Z}$.
        ...
        \end{equation*}
        Luego quedan $Z_2(T^2)=C_2(T^2)\simeq \mathbb{Z}$ y $B_1(T^2)=\{0\}$. 

        Ambas $1$-celdas se pegan al $0$-esqueleto en $e^0$, ambas son lazos luego 
        \begin{equation*}
            \partial_1(e^1_1) = \partial_1(e^1_2) = e^0 - e^0 = 0.
        \end{equation*}
        Por lo que $Z_1(T^2)=C_1(T^2)\simeq \mathbb{Z}^2$. De esta manera, se tiene 
        \begin{equation*}
            H_2(T^2)=Z_2/B_2 = \mathbb{Z}/\{0\} = \mathbb{Z} ~\text{ y }~ H_1(T^2)=Z_1/B_1= \mathbb{Z}^2/\{0\} = \mathbb{Z}^2.
        \end{equation*}

        Y $H_0(T^2)\simeq \mathbb{Z}$ por ser conexo por caminos.
        ...
        \begin{equation*}
            H_k(\mathbb{CP}^n) =
            \begin{cases}
                \mathbb{Z} &\text{ si } k\le 2n \text{ es par},\\
