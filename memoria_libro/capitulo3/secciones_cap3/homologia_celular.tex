...
\begin{example}\label{ejemplos_hom_celular}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        Ahora, $C_2(T^2)\simeq \mathbb{Z}\langle e^2 \rangle \simeq \mathbb{Z}$, $C_1(T^2)\simeq \mathbb{Z}\langle e^1_1 \rangle \oplus \mathbb{Z}\langle e^1_2 \rangle \simeq \mathbb{Z}^2$ y $C_0(T^2)\simeq \mathbb{Z}\langle e^0 \rangle$.
