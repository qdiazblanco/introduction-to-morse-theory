...
Una vez más referimos al lector a la fuente original \cite{munoz2021} si desea aclarar algunos de los detalles técnicos más finos que no vamos a demostrar aquí. Se puede demostrar que $H_k(X)\simeq H^{CW}_k(X)$ para cualquier CW-complejo $X$. Así, por transitividad, se tiene que los grupos de homología de un espacio son isomorfos independientemente de la técnica que apliquemos para computarlos.
