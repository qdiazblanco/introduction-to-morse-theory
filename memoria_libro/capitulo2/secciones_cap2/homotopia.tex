...
%Segunda retracción------------------
    ...
    La Figura \ref{fig:diagrama_asa_regiones} muestra de manera esquemática las regiones en las que queda divido $\mathcal{U}$ cerca del asa. La zona con las flechas de punta negra representa la parte de la región $1$ que queda dentro del asa. La zona con las flechas pequeñas de punta hueca coincide con la parte de la región $2$ que queda dentro del asa. La zona oscura es la región $3$. Asimismo, las flechas ilustran qué parte del asa queremos deformar y sobre qué en cada región. Nótese que en la región $3$ no es necesario deformar nada.
    \medskip
...
%%                           %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Aplicaciones de los teoremas sobre el pegado de $\lambda$-celdas}
