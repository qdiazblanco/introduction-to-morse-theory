...
\end{proof}
\begin{remark}
    Al final de la demostración, para ver que se puede aplicar el teorema \ref{dominados} hay que comprobar que tanto $K$ como $M$ están dominados por CW-complejos. Es claro que $K$ está dominado por si mismo. Para demostrar que $M$ lo está, basta observar que es retracto de deformación de un entorno tubular suyo, el cual es, a su vez, difeomorfo a un abierto de $\mathbb{R}^m$ para cierto $m$, y todo abierto de $\mathbb{R}^m$ tiene el tipo de homotopía de un CW-complejo.
\end{remark}
