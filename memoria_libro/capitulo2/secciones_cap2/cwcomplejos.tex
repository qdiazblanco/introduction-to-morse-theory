...
El objetivo de este capítulo es demostrar que toda variedad qeu admita una función de Morse cuyos conjuntos subnivel sean compactos tiene el tipo de homotopía de un CW-complejo (\ref{cwvariedad}). Con ese fin, introducimos formalmente qué entendemos por CW-complejo y tipo de homotopía.
