...
que verifica que para cualesquiera campos vectoriales suaves $X$ e $Y$, la función
  ...
  \]
es suave sobre $M$. Este producto escalar se conoce como \textit{métrica de Riemann}. Cabe mencionar que en ocasiones nos referiremos a una variedad riemanniana solamente como $M$ si no necesitamos hacer uso explícito de la métrica ya que toda variedad diferenciable se puede equipar con una.
