...
Bachelor's Thesis submitted for the Degree in Mathematics at the Universidad Complutense de Madrid (UCM).

The thesis is structured around John Milnor's book "Morse Theory" and seeks to present the foundations of *Morse theory* in as self-contained a manner as possible, from the Morse Lemma to the Morse inequalities. To this end, a third chapter is included introducing homology theory from the simplicial and cellular points of view.

As a secondary objective, the thesis aims to have didactic value and to serve as a solid source for learning Morse theory.

You can find the Spanish original in [`memoria_libro/`](memoria_libro/), the full English translation is available in [`en/`](en/). The slides of the defense (in Spanish) are in [`presentacion/`](presentacion/).
...
#### 1. Morse functions (p. 5)

1.1. Preliminaries and notation (p. 5)
1.2. The Morse Lemma (p. 7)

#### 2. The CW-complex structure of a manifold (p. 15)

2.1. CW-complexes and homotopy type (p. 15)
2.2. On the attaching of λ-cells (p. 18)
2.2.1. Applications of the theorems on the attaching of λ-cells (p. 33)

#### 3. Introduction to homology (p. 37)

3.1. Simplicial homology (p. 37)
3.1.1. Triangulations (p. 38)
3.1.2. Construction of simplicial homology (p. 40)
3.2. Cellular homology (p. 44)
3.3. Relative homology (p. 47)
3.4. Other invariants related to homology (p. 49)

#### 4. Morse inequalities (p. 51)

4.1. Subadditivity (p. 51)
4.2. The inequalities (p. 54)
...
La memoria original en español se encuentra en [`memoria_libro/`](memoria_libro/), la traducción completa al inglés en [`en/`](en/). Las diapositivas de la defensa están en [`presentacion/`](presentacion/).
