...
El último resultado corona la sección relacionando el tipo de homotopía de una variedad diferenciable con el de un CW-complejo cuyas celdas vienen definidas por los puntos críticos de una función de Morse. Su demostración necesitará de dos lemas acerca de un espacio topológico con una celda pegada que probaremos primero.
\vspace{0.5em}
