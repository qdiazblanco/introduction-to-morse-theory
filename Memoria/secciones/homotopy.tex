...
El último resultado corona la sección relacionando el tipo de homotopía de una variedad diferenciable con el de un CW-complejo cuyas células vienen definidas por los puntos críticos de una función de Morse. Su demostración estará basada en dos lema acerca de un espacio topológico con una célula pegada que probaremos primero.
\vspace{0.5em}
...
\begin{theorem}
\label{cwvariedad}
    Si $f$ es una función de Morse sobre una variedad diferenciable $M$ y $M_f^a$ es compacto para cualquier $a\in\mathbb{R}$. Entonces $M$ tiene el tipo de homotopía de un CW-complejo con una $\lambda$-célula por cada punto crítico de índice $\lambda$.
\end{theorem}
\begin{proof}
...
Presentamos brevemente dos ejemplos de apliciones de los teoremas acerca del pegado de $\lambda$-células.
