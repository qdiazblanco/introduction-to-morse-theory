...
En primer lugar introducimos algunas nociones básicas de campos vectoriales sobre una variedad $M$ que nos servirán para probar los resultados de esta sección.
{\color{blue} Aquí podría ir bien definir variedad riemanniana si es necesario, lo demás parece bastante autocontenido.}
...
\begin{definition}
    Sean $(M,\langle\cdot,\cdot\rangle)$ una variedad riemanniana y $f:M\to\mathbb{R}$ suave. Se define el \textit{gradiente de f} como el campo vectorial que verifica 
    \begin{equation*}
        \langle X,\nabla f\rangle = X(f)
    \end{equation*}
