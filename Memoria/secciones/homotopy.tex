...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \end{cases}
    \end{equation*}
    donde $tu$ denota el producto usual de el escalar $t\in [0,1]$ con el vector unitario $u\in \partial e^{\lambda}$. $k$ es continua ya que para $t=\frac{1}{2}$ se tiene
    \begin{equation*}
    ...
    \begin{equation*}
    \begin{cases}
        h_s(x) = x &~~\text{ si }~~ x\in X, ~~s\in[0,1],\\
        h_s(tu) = \frac{4t}{1+s}u &~~\text{ si }~~ 0 \le t \le \frac{1+s}{4}, \\
        h_s(tu) = \varphi_{\frac{4t}{1+s}-1}(u) &~~\text{ si }~~ \frac{1+s}{4} \le t \le \frac{1+s}{2}, \\
        h_s(tu) = \varphi_{2-2t}(u),
        & \frac{1+s}{2} \le t \le 1 .
    \end{cases}
    \end{equation*}
    Es claro que para $s$ igual a $0$ recuperamos $l\circ k$
\end{proof}
\bigskip
