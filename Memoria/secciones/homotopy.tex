...
\begin{proof}
    ...
    \[
        ...
        \end{array}
    \]
    tales que cada una extendiende a la anterior. Sea $K$ la unión de todos los $K_i$ {\color{blue}¿lo de la direct limit topology?}. Sea $\Phi:M\to K$ la función límite, se tiene que $\Phi$ induce isomorfismos entre los grupos de homotopía en todas las dimensiones, entonces, por el teorema \ref{dominados} es una equivalencia homotópica, lo que concluye la demostración.
