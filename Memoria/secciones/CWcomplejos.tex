...
\begin{nota}
    Llamaremos indistintamente \textit{vértices} a las $0$-células, \textit{aristas} a las $1$-células y caras a las $2$-células.

    Nótese que el borde o la frontera de una arista son dos vértices y de una cara una colección finita de aristas.
\end{nota}
