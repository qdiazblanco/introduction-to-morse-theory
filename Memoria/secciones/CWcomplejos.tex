...
\begin{nota}
    Llamaremos indistintamente \textit{vértices} a las $0$-celdas, \textit{aristas} a las $1$-celdas y \textit{caras} a las $2$-celdas. Nótese también que el borde o la frontera de una arista son dos vértices y de una cara una colección finita de aristas.
\end{nota}
