...
\bigskip
{\color{red}FORMALIZAR DEFINICIÓN PARA QUE SE PUEDA UTILIZAR MEJOR EN HOMOLOGIA}
\begin{definition}
...
\begin{nota}
    Llamaremos indistintamente \textit{vértices} a las $0$-células, \textit{aristas} a las $1$-células y caras a las $2$-células. Nótese también que el borde o la frontera de una arista son dos vértices y de una cara una colección finita de aristas.
\end{nota}

\begin{remark}
    Decimos que la dimensión de un CW-complejo $X$ es $n$ si la construcción tiene una cantidad finita $n$ de pasos, en ese caso, $X=X_n$. Como se deja entrever en el último paso de la construcción, un CW-complejo puede tener dimensión infinita.
\end{remark}
