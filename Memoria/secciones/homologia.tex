...
\begin{definition}
    Sea $f \colon (A_\bullet, \partial) \to (B_\bullet, \partial')$ un morfismo de complejos de cadenas. Como $f \circ \partial = \partial' \circ f$, se tiene que
...
Concluimos el desarrollo de los aspectos que necesitamos de homología con la \textit{homología relativa}. En esencia, la homología relativa busca...
