...
Hasta ahora hemos demostrado que dada una variedad diferenciable de dimensión finita, podemos, mediante una función de Morse, extraer su estructura de CW-complejo. Es decir, reconstruirla a partir del pegado de celdas cuyas dimensiones vienen determinadas por el índice de cada uno de los puntos críticos de una función de Morse.
...
\begin{proof}
    ...
    {\color{blue} no se si debería explicar bien por que se cancelan, no me he metido mucho en como se induce la orientación}.
